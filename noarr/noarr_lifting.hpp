...
auto lift(std::istream &in, Struct s, char *offset) -> std::enable_if_t<is_dynamic_dimension<Struct>::value, std::istream&>{
...
template<typename Struct>
auto lift(std::istream &in, Struct s, char *offset) -> std::enable_if_t<!is_dynamic_dimension<Struct>::value && is_static_dimension<Struct>::value, std::istream&>{
    return lift_static<s.length(), Struct>::lift_(in, s, offset);
}

template<typename Struct>
auto lift(std::istream &in, Struct s, char *offset) -> std::enable_if_t<is_point<Struct>::value, std::istream&>{
    return lift(in, std::get<0>(s.sub_structures()), offset + s.offset());
}

template<typename Type>
std::istream &lift(std::istream &in, scalar<Type>, char *offset) {
...
template<typename Struct>
auto unlift(std::ostream &out, Struct s, char *offset) -> std::enable_if_t<is_dynamic_dimension<Struct>::value, std::ostream&>{
    for (std::size_t i = 0; i < s.length(); ++i) {
...
template<typename Struct>
auto unlift(std::ostream &out, Struct s, char *offset) -> std::enable_if_t<!is_dynamic_dimension<Struct>::value && is_static_dimension<Struct>::value, std::ostream&>{
    return unlift_static<s.length(), Struct>::unlift_(out, s, offset);
}

template<typename Struct>
auto unlift(std::ostream &out, Struct s, char *offset) -> std::enable_if_t<is_point<Struct>::value, std::ostream&>{
    return unlift(out, std::get<0>(s.sub_structures()), offset + s.offset());
}

template<typename Type>
std::ostream &unlift(std::ostream &out, scalar<Type>, char *offset) {
